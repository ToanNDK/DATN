...
const SingleBlogPage = async ({
  ...
  const blog: SINGLE_BLOG_QUERYResult | null = (await getSingleBlog(slug)) as any;  
...
const BlogLeft = async ({ slug }: { slug: string }) => {
  ...
  if (!blog?.slug?.current) return null; // tránh lỗi slug null
