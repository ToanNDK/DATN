...
const FavoriteButton = ({
  ...
  return (
    <>
      ...
      (<button className="group relative hover:text-shop_light_green hoverEffect border border-s-shop_light_green/80 hover:border-shop_light_green p-1.5 rounded-sm">
